...
var (
	...
	UserListFail            = retcode.NewCode("000104", "User List Fail")
	UserCountFail           = retcode.NewCode("000105", "User Count Fail")
	UserEncryptPasswordFail = retcode.NewCode("000106", "User Encrypt Password Fail")
	...
	RoleDeleteMenuFail = retcode.NewCode("000208", "Role Delete Menu Fail")
	RoleCreateMenuFail = retcode.NewCode("000209", "Role Create Menu Fail")
	...
	DepartmentCreateUserFail = retcode.NewCode("000408", "Department Create User Fail")
)
